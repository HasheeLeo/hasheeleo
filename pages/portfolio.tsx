const Portfolio = () => (
  <section>
    ...
    <article>
      ...
      <a href='/kitchat-1-bg.png' target='_blank'>
        <img src='/kitchat-1.png' alt='One on One Chatting Screen' />
      </a>
      <a href='/kitchat-2-bg.png' target='_blank'>
        <img src='/kitchat-2.png' alt='Message Threads Screen' />
      </a>
      <a href='/kitchat-3-bg.png' target='_blank'>
